...
for f in filenames:
    ...
    if '3FXI' in n:
        ...
        ind_3FXI = np.where(n=='3FXI')[0]
        A_3FXI   = np.load(dir_input + 'adjacencies'+str(ind), allow_pickle=True)[ind_3FXI][0]
        p_3FXI   = np.load(dir_input + 'proteins'+str(ind), allow_pickle=True)[ind_3FXI][0]
    ...
    if '5KHB' in n:
        ind = f.strip().split('s')[2]
        ind_5KHB = np.where(n=='5KHB')[0]
        A_5KHB   = np.load( dir_input + 'adjacencies'+str(ind), allow_pickle=True)[ind_5KHB][0]
        p_5KHB   = np.load( dir_input + 'proteins'+str(ind), allow_pickle=True)[ind_5KHB][0]
    ...
    if '5KGZ' in n:
        ind = f.strip().split('s')[2]
        ind_5KGZ = np.where(n=='5KGZ')[0]
        A_5KGZ   = np.load( dir_input + 'adjacencies'+str(ind), allow_pickle=True)[ind_5KGZ][0]
        p_5KGZ   = np.load( dir_input + 'proteins'+str(ind), allow_pickle=True)[ind_5KGZ][0]
    ...
    if '6NIV' in n:
        ind = f.strip().split('s')[2]
        ind_6NIV = np.where(n=='6NIV')[0]
        A_6NIV   = np.load( dir_input + 'adjacencies'+str(ind), allow_pickle=True)[ind_6NIV][0]
        p_6NIV   = np.load( dir_input + 'proteins'+str(ind), allow_pickle=True)[ind_6NIV][0]
    ...
    if '2LY4' in n:
        ind = f.strip().split('s')[2]
        ind_2LY4 = np.where(n=='2LY4')[0]
        A_2LY4   = np.load( dir_input + 'adjacencies'+str(ind), allow_pickle=True)[ind_2LY4][0]
        p_2LY4   = np.load( dir_input + 'proteins'+str(ind), allow_pickle=True)[ind_2LY4][0]
